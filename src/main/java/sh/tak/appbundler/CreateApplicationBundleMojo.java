...
public class CreateApplicationBundleMojo extends AbstractMojo {
	...
	/**
	 * Use the jar produced by maven-assembly-plugin's jar-with-dependencies
	 *
	 * @parameter default-value="false"
	 */
	private boolean useJarWithDependenciesInsteadOfProjectArtifact;
		...
		if (jrePath != null) {
			...
			if (f.exists() && f.isDirectory()) {
				...
				try {
					...
					org.apache.commons.io.FileUtils.copyDirectory(sourceFolder, pluginsDirectory);
